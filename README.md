...
While it isn't 100% faithful to the operation of the original master server I believe the changes are for the better. See the [Differences](#differences) section for more info.
...
When any page is accessed a database with all of the necessary columns will be automatically created.

## Master Server operation and interaction documentation
To see my findings on how the master server is expected to operate and interact with clients and servers check out the [Barotrauma Legacy Master Server Interaction Documentation](Barotrauma%20Legacy%20Master%20Server%20Interaction%20Documentation.md) file.
